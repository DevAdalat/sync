...
def train_model(args):
    ...
    schedule = optax.warmup_cosine_decay_schedule(
        ...
        decay_steps=args.max_steps if args.max_steps else len(inputs) // args.batch_size * args.epochs,
    ...
    for epoch in range(args.epochs):
        ...
        if avg_loss < best_loss:
            best_loss = avg_loss
            checkpoint_path = f"{args.output_dir}/best_checkpoint"
...
def main():
 ...
 Examples:
   ...
   python train_hf_dataset.py --list-columns --dataset wikitext --dataset-config wikitext-2-raw-v1
    ...
    parser.add_argument("--prefer-depth", action="store_true", default=True,
                       help="Prefer deeper models over wider ones")
    
    # Tokenizer arguments
    parser.add_argument("--vocab-size", type=int, default=10000,
                       help="Vocabulary size for tokenizer (default: 10000)")
    parser.add_argument("--tokenizer-train-examples", type=int, default=10000,
