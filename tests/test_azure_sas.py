...
def test_azure_sas():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            cloud_path = upload_checkpoint_to_cloud(checkpoint_path, cloud_config, "test_checkpoint")
            ...
            local_path = download_checkpoint_from_cloud(cloud_path, cloud_config, download_dir)
